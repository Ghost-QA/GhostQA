  ...
  const get_host = async () => {
    ...
    await axios
      .get(
        ...
        `${BASE_URL}/Selenium/GetChartDetails?TestSuiteName=${selectedSuite.suiteName}&RootId=${selectedSuite.rootId}&Filtertype=${filterType}&FilterValue=${filterValue.value}`,
        header()
      )
      .then((response) => {
