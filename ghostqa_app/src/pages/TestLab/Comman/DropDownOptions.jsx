...
const surenderList = [
  ...
  "element_not_exist",
  "element_is_visible",
  "element_is_not_visible",
  "element_is_enabled",
  "element_is_disabled",
  "element_has_value",
  "element_has_attribute_with_value",
  "element_has_css_property_with_value",
  "invoke_value",
  "validate_page_title",
  "validate_current_url",
  "number_of_element_found",
  "blur_element",
  "fixture",
  "focus",
  "force_click",
...
const userActionsOptions = [
  ...
  {
    label: "Element have attibute with value",
    value: "element_has_attribute_with_value",
  },
  {
    label: "Element has CSS property with value",
    value: "element_has_css_property_with_value",
  },
